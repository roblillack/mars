...
func TestInvokeArgType(t *testing.T) {
	...
	testInterceptorController(t, reflect.ValueOf(&n), MethodsN)
	testInterceptorController(t, reflect.ValueOf(&p), MethodsP)
	testInterceptorController(t, reflect.ValueOf(&np), MethodsN)
	testInterceptorController(t, reflect.ValueOf(&np), MethodsP)
}
