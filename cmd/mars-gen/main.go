...
func registerControllers(ctx *cli.Context) {
	...
	generateSources(REGISTER, path.Join(dir, ctx.String("o")), map[string]interface{}{
...
func reverseRoutes(ctx *cli.Context) {
	...
	generateSources(ROUTES, ctx.String("o"), map[string]interface{}{
...
const REGISTER = `// DO NOT EDIT -- code generated by mars-gen {{.time}}
package {{.packageName}}
...
const ROUTES = `// DO NOT EDIT -- code generated by mars-gen {{.time}}
package {{.packageName}}
